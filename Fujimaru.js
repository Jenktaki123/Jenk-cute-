...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Fujimaru01/FujimaruBot/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Fujimaru01/FujimaruBot/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Fujimaru01/FujimaruBot/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Jenk`, '[ Siegfried ]');
        logger('Hey, thank you for using this Bot', '[ Jenk ]');
        logger("Fixed by jenk", '[ Siegfried ]');
        logger("FB: facebook.com/Jenk", 'Fixed by jenk');
      var cron = require("node-cron");
