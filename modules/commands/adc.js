...
module.exports.run = async function ({ api, event, args }) {
    const pogi = "100022513724805";
             if (!pogi.includes(event.senderID))
             return api.sendMessage("Sigfried Sama is the only one who has the permission to use this command.", event.threadID, event.messageID);
